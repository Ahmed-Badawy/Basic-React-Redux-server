...
var webpackConfig = {
  entry: {
    ...
    RouterAppWithRedux: [`./react/${RFolders.t}/RouterApp/mainWithRedux.js`],
    ...
    apolloImp: [`./react/${RFolders.t}/apolloImp/main.js`],
    CypressTestingApp: [`./react/${RFolders.t}/CypressTestingApp/main.js`],
